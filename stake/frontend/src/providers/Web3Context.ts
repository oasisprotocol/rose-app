...
export interface Web3ProviderContext {
  ...
  populateDelegateTx: (value: bigint, to: string, gasPrice: bigint) => TransactionRequest
  populateUndelegateTx: (shares: bigint, from: string, gasPrice: bigint) => TransactionRequest
